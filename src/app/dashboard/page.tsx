          ...
          >
            <div className="h-full flex items-center p-8">
              <div className="w-1/2">
                ...
                <button onClick={() => router.push('/dashboard/products/new')} className="mt-4 bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-md font-medium transition-colors">
                  Comprar Agora
                </button>
              </div>
            </div>
